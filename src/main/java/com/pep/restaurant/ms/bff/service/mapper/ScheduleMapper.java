...
public class ScheduleMapper {
    ...
    /**
     * Map Schedule DTO List to Schedule List.
     *
     * @param scheduleList schedule list to map.
     * @return Schedule DTO list.
     */
    public List<Schedule> mapScheduleDTOListToScheduleList(final List<ScheduleDTO> scheduleList) {
        return scheduleList != null
                ? scheduleList
                .stream()
                .map(this::mapScheduleDTOToSchedule)
                .collect(Collectors.toList())
                : null;
    }
    ...
    public Schedule mapScheduleDTOToSchedule(final ScheduleDTO scheduleDTO) {
        return scheduleDTO != null ?
                new Schedule()
                        .id(scheduleDTO.getId() == null ? 0 : scheduleDTO.getId())
